package com.aforo255.mshistorical.listener;
...
public class ConsumerListenerManualOffset implements CommandLineRunner {
    ...
    public ConsumerListenerManualOffset(TransactionService transactionService) {
        this.transactionService = transactionService;

        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, BOOTSTRAP_SERVERS);
        props.put(ConsumerConfig.CLIENT_ID_CONFIG, "sample-consumer");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "transaction-events-historical");
